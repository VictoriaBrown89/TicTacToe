...
//TODO: Write the declaration for the function that checks for a winner: DONE.
int checkForWinner();
...
int main()
{
	...
	do
	{
		//TODO: Call the function that draws the game board: DONE.
		drawBoard();
		...
		//TODO: Call the checkValidMove function, make sure to save the return value in one of the variables: DONE.
...
int checkForWinner()
{
	...
	//what type of return statement belongs in each of the comments below: DONE.
...
//TODO: Based on the function initiation at the beginning of the program, write the function signature, make sure the variable names are consistent: DONE.
